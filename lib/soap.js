 ...
 * @param {String} [options.endpointUrl] - SOAP endpoint URL (default is Partner endpoint for connection)
 * @param {String} [options.xmlns] - XML namespace for method call (default is "urn:partner.soap.sforce.com")
 */
var SOAP = module.exports = function(conn, options) {
  options = options || {};
  SOAP.super_.apply(this, arguments);
  this._endpointUrl = options.endpointUrl || (conn.instanceUrl + '/services/Soap/u/' + conn.version);
